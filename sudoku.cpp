...
bool Sudoku::is_valid (int x, int y, int val) {
...
bool Sudoku::check_row (int y, int val) {
    for(int i = 0; i < 9; ++i){
        int j = grid[y][i];
        if(j == val)
            return false;
...
bool Sudoku::check_col(int x, int val){
    for(int i = 0; i < 9; ++i){
        int j = grid[i][x];
        if(j == val)
            return false;
...
bool Sudoku::check_block(int x, int y, int val){
